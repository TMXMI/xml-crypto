...
SignedXml.prototype.validateSignatureValue = function() {
  ...
  // Patch to fix https://github.com/yaronn/xml-crypto/issues/137 for my use
  signedInfoCanon = signedInfoCanon.replace('<SignedInfo xmlns="http://www.w3.org/2000/09/xmldsig#">', '<SignedInfo xmlns="http://www.w3.org/2000/09/xmldsig#" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion">')
...
SignedXml.prototype.validateReferences = function(doc) {
  for (var r in this.references) {
    ...
    // Patch to fix https://github.com/yaronn/xml-crypto/issues/137 for my use
    canonXml = canonXml.replace('<Assertion xmlns="urn:oasis:names:tc:SAML:2.0:assertion"', '<Assertion xmlns="urn:oasis:names:tc:SAML:2.0:assertion" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion"')
